...
const (
	JWT_KEY                         string = "dd9*uYCOMMUNITY"
	JWT_DEFAULT_EXPIRE_SECONDS      int64    = 3600 // default 1 hour
	JWT_DEFAULT_LONG_EXPIRE_SECONDS int64    = 3600*24 // default 1 days
)
